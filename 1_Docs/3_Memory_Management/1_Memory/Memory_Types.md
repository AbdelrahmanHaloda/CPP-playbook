...
On Mac, information about the system cache can be obtained by executing the command **`sysctl -a hw`** in a terminal. On Debian linux, this information can be found with **`lscpu | grep cache`**.
